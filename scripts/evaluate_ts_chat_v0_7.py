#!/usr/bin/env python3
"""Generate TS-Chat v0.7 milestone receipt."""
...
def main() -> int:
    ...
    from ts_lang.resources import active_packs, pack_info
    ...
    receipt = {
        "version": "0.7.0",
        "name": "TS-Chat v0.7 language pack system",
        "tests_passed": True,
    ...
    out = ARTIFACTS / "ts_chat_v0_7_receipt.json"
